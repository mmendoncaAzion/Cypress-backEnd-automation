...
describe('DNS   Zones - Comprehensive API Tests', { 
  ...
  afterEach(() => {
    if (testResources.length > 0) {
      cy.cleanupTestResources('DNS - Zones', testResources)
      testResources = []
    }
  })

  describe('GET /workspace/dns/zones', () => {
    const endpoint = '/workspace/dns/zones'
    const method = 'GET'
  ...
  describe('POST /workspace/dns/zones', () => {
    const endpoint = '/workspace/dns/zones'
    const method = 'POST'
  ...
  describe('GET /workspace/dns/zones/{zone_id}', () => {
    const endpoint = '/workspace/dns/zones/{zone_id}'
    const method = 'GET'
  ...
  describe('PUT /workspace/dns/zones/{zone_id}', () => {
    const endpoint = '/workspace/dns/zones/{zone_id}'
    const method = 'PUT'
  ...
  describe('PATCH /workspace/dns/zones/{zone_id}', () => {
    const endpoint = '/workspace/dns/zones/{zone_id}'
    const method = 'PATCH'
  ...
  describe('DELETE /workspace/dns/zones/{zone_id}', () => {
    const endpoint = '/workspace/dns/zones/{zone_id}'
    const method = 'DELETE'
