...
describe('Data Stream   Templates - Comprehensive API Tests', { 
  ...
  beforeEach(() => {
    cy.logTestInfo('Data Stream   Templates Tests', 'Data Stream - Templates')
  })

  afterEach(() => {
    if (testResources.length > 0) {
      cy.cleanupTestResources('Data Stream - Templates', testResources)
      testResources = []
    }
  })

  describe('GET /workspace/stream/templates', () => {
    const endpoint = '/workspace/stream/templates'
    const method = 'GET'
  ...
  describe('POST /workspace/stream/templates', () => {
    const endpoint = '/workspace/stream/templates'
    const method = 'POST'
  ...
  describe('GET /workspace/stream/templates/{template_id}', () => {
    const endpoint = '/workspace/stream/templates/{template_id}'
    const method = 'GET'
  ...
  describe('PUT /workspace/stream/templates/{template_id}', () => {
    const endpoint = '/workspace/stream/templates/{template_id}'
    const method = 'PUT'
  ...
  describe('PATCH /workspace/stream/templates/{template_id}', () => {
    const endpoint = '/workspace/stream/templates/{template_id}'
    const method = 'PATCH'
  ...
  describe('DELETE /workspace/stream/templates/{template_id}', () => {
    const endpoint = '/workspace/stream/templates/{template_id}'
    const method = 'DELETE'
