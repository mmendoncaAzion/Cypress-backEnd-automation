...
describe('Data Stream   Streams - Comprehensive API Tests', {
  ...
  tags: ['@api', '@comprehensive', '@data stream - streams'] 
}, () => {
  let testResources = []

  beforeEach(() => {
    cy.logTestInfo('Data Stream   Streams Tests', 'Data Stream - Streams')
  })

  afterEach(() => {
    if (testResources.length > 0) {
      cy.cleanupTestResources('Data Stream - Streams', testResources)
      testResources = []
    }
  })

  describe('GET /workspace/stream/streams', () => {
    const endpoint = '/workspace/stream/streams'
    const method = 'GET'
  ...
  describe('POST /workspace/stream/streams', () => {
    const endpoint = '/workspace/stream/streams'
    const method = 'POST'
  ...
  describe('GET /workspace/stream/streams/{stream_id}', () => {
    const endpoint = '/workspace/stream/streams/{stream_id}'
    const method = 'GET'
  ...
  describe('PUT /workspace/stream/streams/{stream_id}', () => {
    const endpoint = '/workspace/stream/streams/{stream_id}'
    const method = 'PUT'
  ...
  describe('PATCH /workspace/stream/streams/{stream_id}', () => {
    const endpoint = '/workspace/stream/streams/{stream_id}'
    const method = 'PATCH'
  ...
  describe('DELETE /workspace/stream/streams/{stream_id}', () => {
    const endpoint = '/workspace/stream/streams/{stream_id}'
    const method = 'DELETE'
