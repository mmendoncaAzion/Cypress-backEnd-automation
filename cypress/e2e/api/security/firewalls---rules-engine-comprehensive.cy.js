...
describe('Firewalls   Rules Engine - Comprehensive API Tests', { 
  tags: ['@api', '@comprehensive', '@firewalls - rules engine'] 
}, () => {
  let testResources = []

  beforeEach(() => {
    cy.logTestInfo('Firewalls   Rules Engine Tests', 'Firewalls - Rules Engine')
  })

  afterEach(() => {
    if (testResources.length > 0) {
      cy.cleanupTestResources('Firewalls - Rules Engine', testResources)
      testResources = []
    }
  })

  describe('GET /workspace/firewalls/{edge_firewall_id}/request_rules', () => {
    const endpoint = '/workspace/firewalls/{edge_firewall_id}/request_rules'
    const method = 'GET'
  ...
  describe('POST /workspace/firewalls/{edge_firewall_id}/request_rules', () => {
    const endpoint = '/workspace/firewalls/{edge_firewall_id}/request_rules'
    const method = 'POST'
  ...
  describe('GET /workspace/firewalls/{edge_firewall_id}/request_rules/{id}', () => {
    const endpoint = '/workspace/firewalls/{edge_firewall_id}/request_rules/{id}'
    const method = 'GET'
  ...
  describe('PUT /workspace/firewalls/{edge_firewall_id}/request_rules/{id}', () => {
    const endpoint = '/workspace/firewalls/{edge_firewall_id}/request_rules/{id}'
    const method = 'PUT'
  ...
  describe('PATCH /workspace/firewalls/{edge_firewall_id}/request_rules/{id}', () => {
    const endpoint = '/workspace/firewalls/{edge_firewall_id}/request_rules/{id}'
    const method = 'PATCH'
  ...
  describe('DELETE /workspace/firewalls/{edge_firewall_id}/request_rules/{id}', () => {
    const endpoint = '/workspace/firewalls/{edge_firewall_id}/request_rules/{id}'
    const method = 'DELETE'
  ...
  describe('PUT /workspace/firewalls/{edge_firewall_id}/request_rules/order', () => {
    const endpoint = '/workspace/firewalls/{edge_firewall_id}/request_rules/order'
    const method = 'PUT'
