...
describe('Firewalls   Function - Comprehensive API Tests', () => {
  ...
  beforeEach(() => {
    cy.logTestInfo('Firewalls   Function Tests', 'Firewalls - Function')
  })

  afterEach(() => {
    if (testResources.length > 0) {
      cy.cleanupTestResources('Firewalls - Function', testResources)
      testResources = []
    }
  })

  describe('GET /workspace/firewalls/{edge_firewall_id}/functions', () => {
    const endpoint = '/workspace/firewalls/{edge_firewall_id}/functions'
    const method = 'GET'
  ...
  describe('POST /workspace/firewalls/{edge_firewall_id}/functions', () => {
    const endpoint = '/workspace/firewalls/{edge_firewall_id}/functions'
    const method = 'POST'
  ...
  describe('GET /workspace/firewalls/{edge_firewall_id}/functions/{id}', () => {
    const endpoint = '/workspace/firewalls/{edge_firewall_id}/functions/{id}'
    const method = 'GET'
  ...
  describe('PUT /workspace/firewalls/{edge_firewall_id}/functions/{id}', () => {
    const endpoint = '/workspace/firewalls/{edge_firewall_id}/functions/{id}'
    const method = 'PUT'
  ...
  describe('PATCH /workspace/firewalls/{edge_firewall_id}/functions/{id}', () => {
    const endpoint = '/workspace/firewalls/{edge_firewall_id}/functions/{id}'
    const method = 'PATCH'
  ...
  describe('DELETE /workspace/firewalls/{edge_firewall_id}/functions/{id}', () => {
    const endpoint = '/workspace/firewalls/{edge_firewall_id}/functions/{id}'
    const method = 'DELETE'
