...
describe('Edge Storage   Buckets - Comprehensive API Tests', { 
  tags: ['@api', '@comprehensive', '@edge storage - buckets'] 
}, () => {
  let testResources = []

  beforeEach(() => {
    cy.logTestInfo('Edge Storage   Buckets Tests', 'Edge Storage - Buckets')
  })

  afterEach(() => {
    if (testResources.length > 0) {
      cy.cleanupTestResources('Edge Storage - Buckets', testResources)
      testResources = []
    }
  })

  describe('GET /workspace/storage/buckets', () => {
    const endpoint = '/workspace/storage/buckets'
    const method = 'GET'
  ...
  describe('POST /workspace/storage/buckets', () => {
    const endpoint = '/workspace/storage/buckets'
    const method = 'POST'
  ...
  describe('GET /workspace/storage/buckets/{name}', () => {
    const endpoint = '/workspace/storage/buckets/{name}'
    const method = 'GET'
  ...
  describe('PATCH /workspace/storage/buckets/{name}', () => {
    const endpoint = '/workspace/storage/buckets/{name}'
    const method = 'PATCH'
  ...
  describe('DELETE /workspace/storage/buckets/{name}', () => {
    const endpoint = '/workspace/storage/buckets/{name}'
    const method = 'DELETE'
