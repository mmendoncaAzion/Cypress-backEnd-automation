...
describe('Edge Storage   Objects - Comprehensive API Tests', { 
  ...
  beforeEach(() => {
    cy.logTestInfo('Edge Storage   Objects Tests', 'Edge Storage - Objects')
  })

  afterEach(() => {
    if (testResources.length > 0) {
      cy.cleanupTestResources('Edge Storage - Objects', testResources)
      testResources = []
    }
  })

  describe('GET /workspace/storage/buckets/{bucketName}/objects', () => {
    const endpoint = '/workspace/storage/buckets/{bucketName}/objects'
    const method = 'GET'
  ...
  describe('GET /workspace/storage/buckets/{bucketName}/objects/{objectKey}', () => {
    const endpoint = '/workspace/storage/buckets/{bucketName}/objects/{objectKey}'
    const method = 'GET'
  ...
  describe('POST /workspace/storage/buckets/{bucketName}/objects/{objectKey}', () => {
    const endpoint = '/workspace/storage/buckets/{bucketName}/objects/{objectKey}'
    const method = 'POST'
  ...
  describe('PUT /workspace/storage/buckets/{bucketName}/objects/{objectKey}', () => {
    const endpoint = '/workspace/storage/buckets/{bucketName}/objects/{objectKey}'
    const method = 'PUT'
  ...
  describe('DELETE /workspace/storage/buckets/{bucketName}/objects/{objectKey}', () => {
    const endpoint = '/workspace/storage/buckets/{bucketName}/objects/{objectKey}'
    const method = 'DELETE'
