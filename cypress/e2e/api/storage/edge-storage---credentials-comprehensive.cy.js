...
describe('Edge Storage   Credentials - Comprehensive API Tests', {
  ...
  tags: ['@api', '@comprehensive', '@edge storage - credentials'] 
}, () => {
  let testResources = []

  beforeEach(() => {
    cy.logTestInfo('Edge Storage   Credentials Tests', 'Edge Storage - Credentials')
  })

  afterEach(() => {
    if (testResources.length > 0) {
      cy.cleanupTestResources('Edge Storage - Credentials', testResources)
      testResources = []
    }
  })

  describe('GET /workspace/storage/credentials', () => {
    const endpoint = '/workspace/storage/credentials'
    const method = 'GET'
  ...
  describe('POST /workspace/storage/credentials', () => {
    const endpoint = '/workspace/storage/credentials'
    const method = 'POST'
  ...
  describe('GET /workspace/storage/credentials/{id}', () => {
    const endpoint = '/workspace/storage/credentials/{id}'
    const method = 'GET'
  ...
  describe('DELETE /workspace/storage/credentials/{id}', () => {
    const endpoint = '/workspace/storage/credentials/{id}'
    const method = 'DELETE'
