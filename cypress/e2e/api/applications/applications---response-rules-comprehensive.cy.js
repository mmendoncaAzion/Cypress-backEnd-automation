...
describe('Applications   Response Rules - Comprehensive API Tests', () => {
  ...
  tags: ['@api', '@comprehensive', '@applications - response rules'] 
}, () => {
  let testResources = []

  beforeEach(() => {
    cy.logTestInfo('Applications   Response Rules Tests', 'Applications - Response Rules')
  })

  afterEach(() => {
    if (testResources.length > 0) {
      cy.cleanupTestResources('Applications - Response Rules', testResources)
      testResources = []
    }
  })

  describe('GET /workspace/applications/{application_id}/response_rules', () => {
    const endpoint = '/workspace/applications/{application_id}/response_rules'
    const method = 'GET'
  ...
  describe('POST /workspace/applications/{application_id}/response_rules', () => {
    const endpoint = '/workspace/applications/{application_id}/response_rules'
    const method = 'POST'
  ...
  describe('GET /workspace/applications/{application_id}/response_rules/{id}', () => {
    const endpoint = '/workspace/applications/{application_id}/response_rules/{id}'
    const method = 'GET'
  ...
  describe('PUT /workspace/applications/{application_id}/response_rules/{id}', () => {
    const endpoint = '/workspace/applications/{application_id}/response_rules/{id}'
    const method = 'PUT'
  ...
  describe('PATCH /workspace/applications/{application_id}/response_rules/{id}', () => {
    const endpoint = '/workspace/applications/{application_id}/response_rules/{id}'
    const method = 'PATCH'
  ...
  describe('DELETE /workspace/applications/{application_id}/response_rules/{id}', () => {
    const endpoint = '/workspace/applications/{application_id}/response_rules/{id}'
    const method = 'DELETE'
  ...
  describe('PUT /workspace/applications/{application_id}/response_rules/order', () => {
    const endpoint = '/workspace/applications/{application_id}/response_rules/order'
    const method = 'PUT'
