...
describe('Applications   Device Groups - Comprehensive API Tests', { 
  tags: ['@api', '@comprehensive', '@applications - device groups'] 
}, () => {
  let testResources = []

  beforeEach(() => {
    cy.logTestInfo('Applications   Device Groups Tests', 'Applications - Device Groups')
  })

  afterEach(() => {
    if (testResources.length > 0) {
      cy.cleanupTestResources('Applications - Device Groups', testResources)
      testResources = []
    }
  })

  describe('GET /workspace/applications/{application_id}/device_groups', () => {
    const endpoint = '/workspace/applications/{application_id}/device_groups'
    const method = 'GET'
  ...
  describe('POST /workspace/applications/{application_id}/device_groups', () => {
    const endpoint = '/workspace/applications/{application_id}/device_groups'
    const method = 'POST'
  ...
  describe('GET /workspace/applications/{application_id}/device_groups/{id}', () => {
    const endpoint = '/workspace/applications/{application_id}/device_groups/{id}'
    const method = 'GET'
  ...
  describe('PUT /workspace/applications/{application_id}/device_groups/{id}', () => {
    const endpoint = '/workspace/applications/{application_id}/device_groups/{id}'
    const method = 'PUT'
  ...
  describe('PATCH /workspace/applications/{application_id}/device_groups/{id}', () => {
    const endpoint = '/workspace/applications/{application_id}/device_groups/{id}'
    const method = 'PATCH'
  ...
  describe('DELETE /workspace/applications/{application_id}/device_groups/{id}', () => {
    const endpoint = '/workspace/applications/{application_id}/device_groups/{id}'
    const method = 'DELETE'
